...
class TranslateSkill(Skill):
    ...
    @property
    def description(self) -> str: return "Detect language and prepare text for translation"

    def tools(self) -> list[ToolDefinition]:
        return [
            ToolDefinition(name="detect_language", description="Detect the language of text",
                parameters={"type":"object","properties":{
                    "text":{"type":"string","description":"Text to analyze"},
                },"required":["text"]}),
            ToolDefinition(name="translation_prompt", description="Generate a translation prompt for the agent to execute",
                parameters={"type":"object","properties":{
                    "text":{"type":"string","description":"Text to translate"},
                    "target_language":{"type":"string","description":"Target language (e.g., Spanish, French, Japanese)"},
                    "tone":{"type":"string","description":"Tone: formal, casual, technical (default: neutral)"},
                },"required":["text","target_language"]}),
        ]

    async def execute(self, tool_name: str, arguments: dict[str, Any]) -> Any:
        match tool_name:
            case "detect_language": return self._detect(arguments["text"])
            case "translation_prompt": return self._prompt(arguments["text"], arguments["target_language"], arguments.get("tone","neutral"))
    ...
    def _prompt(self, text: str, target: str, tone: str) -> str:
        ...
        return (f"Translate the following from {src_name} to {target}.{tone_inst} "
